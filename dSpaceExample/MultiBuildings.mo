...
package MultiBuildings "Models for multi-building HIL experiments"
  model TwoBldgsDemo "Test for two buildings"
    ...
    Modelica.Blocks.Interfaces.RealInput yBldg2TES_uMod
      "-1: Charge TES; 0: off; 1: Discharge TES; 2: Discharge chiller"
      annotation (Placement(transformation(extent={{-168,108},{-148,128}}),
  ...
  equation
    ...
    connect(uModtoInt.u, yBldg2TES_uMod) annotation (Line(points={{-112,126},{
            -150,126},{-150,118},{-158,118}}, color={0,0,127}));
    annotation (
  ...
  model TwoBldgs20251224_test "System example for fault injection"
   ...
   extends dSpaceExample.FiveZones.BaseClasses.RunTime;
    ...
    Modelica.Blocks.Sources.RealExpression towTApp(y=cooTow.TWatOut_nominal -
          cooTow.TAirInWB_nominal) "Cooling tower approach temperature"
    ...
    Modelica.Blocks.Interfaces.RealOutput TRooAirSou "Room air temperature"
      annotation (Placement(transformation(extent={{1206,718},{1226,738}}),
          iconTransformation(extent={{260,20},{280,40}})));
    ...
    VirtualTestbed.NISTChillerTestbed.DemandFlexibilityInvestigation.FakeSystem.SystemForMPC_1bInput_modeSignal
      bldg2TES
      annotation (Placement(transformation(extent={{426,-630},{604,-452}})));
    UnitConversion.KToF kToF22
      annotation (Placement(transformation(extent={{740,-470},{760,-450}})));
    UnitConversion.ToAnolog toV45(
      x_min=25,
      x_max=125,
      v_min=0,
      v_max=5)  "25/125F mapping to 0-10v"
      annotation (Placement(transformation(extent={{772,-470},{792,-450}})));
    Modelica.Blocks.Interfaces.RealOutput TtesRooAirSou_V
      "Room air temperature" annotation (Placement(transformation(extent={{814,
              -470},{834,-450}}), iconTransformation(extent={{260,20},{280,40}})));
    Modelica.Blocks.Sources.RealExpression TtesRooAirSou(y=bldg2TES.conVAVSou.TZon)
      annotation (Placement(transformation(extent={{700,-470},{720,-450}})));
    Modelica.Blocks.Math.RealToInteger uModtoInt
      "-1: Charge TES; 0: off; 1: Discharge TES; 2: Discharge chiller"
      annotation (Placement(transformation(extent={{300,-480},{320,-460}})));
    Modelica.Blocks.Interfaces.RealInput yBldg2TES_uMod
      "-1: Charge TES; 0: off; 1: Discharge TES; 2: Discharge chiller"
      annotation (Placement(transformation(extent={{238,-480},{258,-460}}),
          iconTransformation(extent={{-220,-260},{-200,-240}})));
  equation
    ...
    connect(kToF1.F, TRooAirSou) annotation (Line(points={{1121,710},{1126,710},
            {1126,728},{1216,728}},
                                  color={0,0,127}));
    ...
    connect(kToF22.F, toV45.x)
      annotation (Line(points={{761,-460},{770,-460}}, color={0,0,127}));
    connect(toV45.v, TtesRooAirSou_V)
      annotation (Line(points={{793,-460},{824,-460}}, color={0,0,127}));
    connect(TtesRooAirSou.y, kToF22.K)
      annotation (Line(points={{721,-460},{738,-460}}, color={0,0,127}));
    connect(uModtoInt.y, bldg2TES.uMod) annotation (Line(points={{321,-470},{
            356,-470},{356,-469.8},{408.2,-469.8}}, color={255,127,0}));
    connect(uModtoInt.u, yBldg2TES_uMod)
      annotation (Line(points={{298,-470},{248,-470}}, color={0,0,127}));
    annotation (
