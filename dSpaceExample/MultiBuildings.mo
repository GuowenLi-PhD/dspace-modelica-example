...
package MultiBuildings "Models for multi-building HIL experiments"
  model TwoBldgsDemo "Test for two buildings"
    ...
    FiveZones.FiveZonesVAVAHUChiller         bldg1NoTES
      "fiveZonesVAVAHUChiller"
      annotation (Placement(transformation(extent={{-70,-12},{-16,20}})));
    ...
    Modelica.Blocks.Sources.Constant yEcoMinOA(k=10)
      annotation (Placement(transformation(extent={{-198,-18},{-178,2}})));
    ...
    VirtualTestbed.NISTChillerTestbed.DemandFlexibilityInvestigation.FakeSystem.SystemForMPC_1iInput_modeSignal
      bldg2TES
      annotation (Placement(transformation(extent={{16,-34},{194,144}})));
    UnitConversion.KToF kToF22
      annotation (Placement(transformation(extent={{330,126},{350,146}})));
    UnitConversion.ToAnolog toV46(
      x_min=25,
      x_max=125,
      v_min=0,
      v_max=5)  "25/125F mapping to 0-10v"
      annotation (Placement(transformation(extent={{362,126},{382,146}})));
    Modelica.Blocks.Sources.RealExpression TtesRooAirSou(y=bldg2TES.conVAVSou.TZon)
      annotation (Placement(transformation(extent={{290,126},{310,146}})));
    Modelica.Blocks.Math.RealToInteger uModtoInt
      "-1: Charge TES; 0: off; 1: Discharge TES; 2: Discharge chiller"
      annotation (Placement(transformation(extent={{-110,116},{-90,136}})));
    Modelica.Blocks.Interfaces.RealOutput TtesRooAirSou_V
      "Room air temperature" annotation (Placement(transformation(extent={{404,
              126},{424,146}}), iconTransformation(extent={{260,20},{280,40}})));
    Modelica.Blocks.Sources.Constant uMod(k=2)
      annotation (Placement(transformation(extent={{-160,140},{-140,160}})));
  equation
    connect(yHea.y, bldg1NoTES.yHeaCor) annotation (Line(points={{-63,-50},{-62,
            -50},{-62,21.6},{-60.7709,21.6}}, color={0,0,127}));
    connect(yHea.y, bldg1NoTES.yHeaWes) annotation (Line(points={{-63,-50},{-62,
            -50},{-62,24.4},{-60.7709,24.4}}, color={0,0,127}));
    connect(yHea.y, bldg1NoTES.yHeaNor) annotation (Line(points={{-63,-50},{-63,
            -11},{-60.7709,-11},{-60.7709,27.2}}, color={0,0,127}));
    connect(yHea.y, bldg1NoTES.yHeaEas) annotation (Line(points={{-63,-50},{
            -60.7709,-50},{-60.7709,30}}, color={0,0,127}));
    connect(yHea.y, bldg1NoTES.yHeaSou) annotation (Line(points={{-63,-50},{
            -60.7709,-50},{-60.7709,32.8}}, color={0,0,127}));
    connect(yVAV.y, bldg1NoTES.yVAVSou) annotation (Line(points={{-79,82},{-78,
            82},{-78,32.6},{-68.6255,32.6}}, color={0,0,127}));
    connect(yVAV.y, bldg1NoTES.yVAVEas) annotation (Line(points={{-79,82},{-78,
            82},{-78,29.8},{-68.6255,29.8}}, color={0,0,127}));
    connect(yVAV.y, bldg1NoTES.yVAVNor) annotation (Line(points={{-79,82},{-78,
            82},{-78,27},{-68.6255,27}}, color={0,0,127}));
    connect(yVAV.y, bldg1NoTES.yVAVWes) annotation (Line(points={{-79,82},{-78,
            82},{-78,24.2},{-68.6255,24.2}}, color={0,0,127}));
    connect(yVAV.y, bldg1NoTES.yVAVCor) annotation (Line(points={{-79,82},{-78,
            82},{-78,21.4},{-68.6255,21.4}}, color={0,0,127}));
    connect(yHeaVal.y, bldg1NoTES.yHeaVal) annotation (Line(points={{-101,-80},
            {-86,-80},{-86,11},{-70.9818,11}}, color={0,0,127}));
    connect(yCooVal.y, bldg1NoTES.yCooVal) annotation (Line(points={{-139,-80},
            {-104,-80},{-104,11},{-70.9818,11}}, color={0,0,127}));
    connect(yExhDam.y, bldg1NoTES.yExhDam) annotation (Line(points={{-139,-48},
            {-106,-48},{-106,11},{-70.9818,11}}, color={0,0,127}));
    connect(yEcoOA.y, bldg1NoTES.yEcoOADam) annotation (Line(points={{-139,-16},
            {-106,-16},{-106,13},{-70.9818,13}}, color={0,0,127}));
    connect(yRetDam.y, bldg1NoTES.yRetAirDam) annotation (Line(points={{-139,16},
            {-106,16},{-106,15},{-70.9818,15}}, color={0,0,127}));
    connect(ySupFanSpe.y, bldg1NoTES.ySupFanSpe) annotation (Line(points={{-139,50},
            {-106,50},{-106,11},{-70.9818,11}},     color={0,0,127}));
    connect(ySupFanOn.y, bldg1NoTES.ySupFanOn) annotation (Line(points={{-139,82},
            {-106,82},{-106,17},{-70.9818,17}},     color={0,0,127}));
    connect(yEcoMinOA.y, bldg1NoTES.yMinOADam) annotation (Line(points={{-177,-8},
            {-124,-8},{-124,13},{-70.9818,13}},     color={0,0,127}));
    connect(ySupFanOn.y, bldg1NoTES.yChiOn) annotation (Line(points={{-139,82},
            {-104,82},{-104,1},{-70.9818,1}}, color={0,0,127}));
    connect(yPump.y, bldg1NoTES.yCHWPumSpe) annotation (Line(points={{-75,-22},
            {-72,-22},{-72,-1},{-70.9818,-1}}, color={0,0,127}));
    connect(yPump.y, bldg1NoTES.yCWPumSpe) annotation (Line(points={{-75,-22},{
            -72,-22},{-72,-3},{-70.9818,-3}}, color={0,0,127}));
    connect(yPump.y, bldg1NoTES.yCTSpe) annotation (Line(points={{-75,-22},{-72,
            -22},{-72,-5},{-70.9818,-5}}, color={0,0,127}));
    connect(kToF22.F, toV46.x)
      annotation (Line(points={{351,136},{360,136}}, color={0,0,127}));
    connect(toV46.v, TtesRooAirSou_V)
      annotation (Line(points={{383,136},{414,136}}, color={0,0,127}));
    connect(TtesRooAirSou.y, kToF22.K)
      annotation (Line(points={{311,136},{328,136}}, color={0,0,127}));
    connect(uModtoInt.y, bldg2TES.uMod) annotation (Line(points={{-89,126},{-54,
            126},{-54,126.2},{-1.8,126.2}}, color={255,127,0}));
    connect(uMod.y, uModtoInt.u) annotation (Line(points={{-139,150},{-126.5,
            150},{-126.5,126},{-112,126}}, color={0,0,127}));
    annotation (
      Icon(coordinateSystem(preserveAspectRatio=false), graphics={
          ...
          Polygon(
            points={{-80,40},{-50,60},{-20,40},{-80,40}},
            lineColor={28,108,200},
            fillColor={162,29,33},
            fillPattern=FillPattern.Solid),
          Rectangle(
          ...
          Polygon(
            ...
            fillPattern=FillPattern.None),
          Polygon(
            points={{20,40},{50,60},{80,40},{20,40}},
            lineColor={28,108,200},
            fillColor={162,29,33},
            fillPattern=FillPattern.Solid)}),
  ...
  model TwoBldgs20251224 "System example for fault injection"
    ...
    extends dSpaceExample.FiveZones.BaseClasses.PartialAirsideFiveZonesAHU(
      fanSup(show_T=false, per=perSupFan),
      conAHU(
        pNumIgnReq=1,
        TSupSetMin=284.95,
        numIgnReqSupTem=1,
    ...
    extends dSpaceExample.FiveZones.BaseClasses.PartialWaterside(
      ...
      pumCW(use_inputFilter=true, per=perPumCWNew),
   ...
   extends dSpaceExample.FiveZones.BaseClasses.RunTime;
    ...
    parameter Buildings.Fluid.Movers.Data.Generic[numChi] perPumPri(
      ...
      each hydraulicEfficiency=Buildings.Fluid.Movers.BaseClasses.Characteristics.efficiencyParameters(
          V_flow={0},
          eta={1}),
    ...
    parameter Buildings.Fluid.Movers.Data.Generic perPumCWNew(
      each pressure=Buildings.Fluid.Movers.BaseClasses.Characteristics.flowParameters(
    ...
    parameter Buildings.Fluid.Movers.Data.Generic perSupFan(
        pressure=Buildings.Fluid.Movers.BaseClasses.Characteristics.flowParameters(
              V_flow=m_flow_nominal/1.2*{0.2,0.6,1.0,1.2},
              dp=(1030 + 220 + 10 + 20 + dpBuiStaSet)*{1.2,1.1,1.0,0.6}),
        hydraulicEfficiency=Buildings.Fluid.Movers.BaseClasses.Characteristics.efficiencyParameters(
          V_flow={0},
          eta={1}),
    ...
    Modelica.Blocks.Interfaces.RealInput yChiOn
      "Voltage signal forchiller on/off" annotation (Placement(transformation(
            extent={{1052,-300},{1072,-280}}), iconTransformation(extent={{-220,-260},
              {-200,-240}})));
    ...
    Modelica.Blocks.Interfaces.RealInput yCHWPumSpe
      "Voltage signal for CHW pump speed" annotation (Placement(transformation(
            extent={{1048,-332},{1076,-304}}), iconTransformation(extent={{-220,-280},
              {-200,-260}})));
    ...
    Modelica.Blocks.Interfaces.RealInput yCWPumSpe
      "Voltage signal for CW pump speed" annotation (Placement(transformation(
            extent={{1048,-374},{1076,-346}}), iconTransformation(extent={{-220,-300},
              {-200,-280}})));
    ...
    Modelica.Blocks.Sources.RealExpression cooMod(y=cooModCon.y)
      annotation (Placement(transformation(extent={{858,-162},{878,-142}})));
    UnitConversion.ToAnolog toV45(
      x_min=0,
      x_max=5,
      v_min=0,
      v_max=5)
      annotation (Placement(transformation(extent={{888,-158},{900,-146}})));
    Modelica.Blocks.Interfaces.RealOutput cooMod_V annotation (Placement(
          transformation(extent={{912,-162},{932,-142}}), iconTransformation(
            extent={{350,-140},{370,-120}})));
    VirtualTestbed.NISTChillerTestbed.DemandFlexibilityInvestigation.FakeSystem.SystemForMPC_1iInput_modeSignal
      bldg2TES
      annotation (Placement(transformation(extent={{404,-646},{582,-468}})));
    UnitConversion.KToF kToF22
      annotation (Placement(transformation(extent={{718,-486},{738,-466}})));
    UnitConversion.ToAnolog toV46(
      x_min=25,
      x_max=125,
      v_min=0,
  ...
  equation
    ...
    connect(wetBul.TWetBul, cooModCon.TWetBul) annotation (Line(points={{-279,
            110},{280,110},{280,-82},{994,-82},{994,-253.778},{1026,-253.778}},
                                                                           color=
            {0,0,127}));
    ...
    connect(conAHU.yHea, yHeaCoi_deb) annotation (Line(points={{424,554.667},{
            590,554.667},{590,510},{606,510}},
                                           color={0,0,127}));
    ...
    connect(chiWSE.TCWRetWSE, kToF19.K) annotation (Line(points={{673,-212},{594,-212},
            {594,-248},{604,-248}}, color={0,0,127}));
    connect(reaToBoo1.y, booToRea5.u)
      annotation (Line(points={{461,-150},{468,-150}}, color={255,0,255}));
    connect(watVal.y_actual, reaToBoo1.u) annotation (Line(points={{531,-113},{512,
            -113},{512,-114},{492,-114},{492,-132},{432,-132},{432,-150},{438,-150}},
          color={0,0,127}));
    ...
    connect(val.y_actual, reaToBoo2.u) annotation (Line(points={{651,-309},{651,-336},
            {394,-336},{394,-356},{406,-356}}, color={0,0,127}));
    connect(toV34.v, dp_WSE_V)
      annotation (Line(points={{555,-208},{572,-208}}, color={0,0,127}));
    connect(chiWSE.dp_WSE, toV34.x) annotation (Line(points={{673,-200.6},{526,-200.6},
            {526,-208},{532,-208}}, color={0,0,127}));
    connect(toV35.v, dp_Chi_V)
      annotation (Line(points={{545,-246},{562,-246}}, color={0,0,127}));
    connect(chiWSE.dp_Chi, toV35.x) annotation (Line(points={{673,-198.8},{516,-198.8},
            {516,-246},{522,-246}}, color={0,0,127}));
    ...
    connect(cooTow.PFan, reaToBoo4.u) annotation (Line(points={{759,-308},{764,-308},
            {764,-336},{736,-336},{736,-368},{740,-368}}, color={0,0,127}));
    ...
    connect(volToUni_yhea6.y, chiWSE.yPum[1]) annotation (Line(points={{1094.6,-318},
            {1098,-318},{1098,-302},{982,-302},{982,-203.6},{695.6,-203.6}},
          color={0,0,127}));
    connect(yCWPumSpe, volToUni_yhea7.v)
      annotation (Line(points={{1062,-360},{1080.8,-360}}, color={0,0,127}));
    connect(volToUni_yhea7.y, pumCW.y) annotation (Line(points={{1094.6,-360},{1094.6,
            -328},{898,-328},{898,-288}}, color={0,0,127}));
    connect(yCTSpe, volToUni_yhea8.v)
      annotation (Line(points={{1062,-388},{1080.8,-388}}, color={0,0,127}));
    connect(volToUni_yhea8.y, cooTow.y) annotation (Line(points={{1094.6,-388},{1098,
            -388},{1098,-398},{726,-398},{726,-308},{736,-308}}, color={0,0,127}));
    connect(kToF21.F, T_CHWSupSet_F)
      annotation (Line(points={{1283,-316},{1302,-316}}, color={0,0,127}));
    connect(temDifPreRes.TSet, kToF21.K) annotation (Line(points={{1217,-249},{1217,
            -258},{1218,-258},{1218,-266},{1242,-266},{1242,-300},{1260,-300},{1260,
            -316}}, color={0,0,127}));
    connect(temDifPreRes.dpSet, dp_CHWSupSet_pa) annotation (Line(points={{1217,-239},
            {1230.5,-239},{1230.5,-224},{1254,-224}}, color={0,0,127}));
    ...
    connect(toV43.v, Power_chiller_V) annotation (Line(points={{424.6,-216},{434,-216},
            {434,-216},{446,-216}}, color={0,0,127}));
    connect(toV44.v, Power_fan_V)
      annotation (Line(points={{298.6,-100},{318,-100}}, color={0,0,127}));
    connect(fanSup.P, toV44.x) annotation (Line(points={{321,-31},{321,-72},{272,-72},
            {272,-100},{284.8,-100}}, color={0,0,127}));
    connect(paTopsi_ahu.PSI, dpDisSupFan_ahu) annotation (Line(points={{205,160},
            {208,160},{208,128},{254,128}}, color={0,0,127}));
    connect(cooMod.y,toV45. x)
      annotation (Line(points={{879,-152},{886.8,-152}}, color={0,0,127}));
    connect(toV45.v, cooMod_V)
      annotation (Line(points={{900.6,-152},{922,-152}}, color={0,0,127}));
    connect(kToF22.F, toV46.x)
      annotation (Line(points={{739,-476},{748,-476}}, color={0,0,127}));
    connect(toV46.v, TtesRooAirSou_V)
  ...
  end TwoBldgs20251224;

  model TwoBldgs_1hil_1dSPACE_Python_20260126
    "Building A (without TES) is in HIL setup with actual controllers; Building B (with TES) is in dSPACE without actual controllers using ASAM XIL API with Python for communication"
    extends dSpaceExample.FiveZones.BaseClasses.PartialHotWaterside(
      final Q_flow_boi_nominal=designHeatLoad,
      minFloBypHW(k=0.1),
      pumSpeHW(reset=Buildings.Types.Reset.Parameter, y_reset=0),
   ...
   extends dSpaceExample.FiveZones.BaseClasses.RunTime;
    ...
    UnitConversion.FromAnalog volToUni_yvav1(
      ...
      y_min=0,
      y_max=1) annotation (Placement(transformation(extent={{488,54},{500,66}})));
    Modelica.Blocks.Interfaces.RealInput yVAVCor
      "Voltage signal for VAV damper"
      annotation (Placement(transformation(extent={{-200,-60},{-172,-32}}),
          iconTransformation(extent={{-200,-60},{-172,-32}})));
    UnitConversion.FromAnalog volToUni_yhea2(
      v_min=0.1,
    ...
    VirtualTestbed.NISTChillerTestbed.DemandFlexibilityInvestigation.FakeSystem.SystemForMPC_1iInput_modeSignal
      bldg2TES
      "2 integer signals: mode signal and VAV core zonal air flow rate"
      annotation (Placement(transformation(extent={{404,-646},{582,-468}})));
    UnitConversion.KToF kToF22
      annotation (Placement(transformation(extent={{718,-486},{738,-466}})));
    UnitConversion.ToAnolog toV46(
    ...
    UnitConversion.FromAnalog volToMode(
      ...
      "0 - 10 V to (-1: Charge TES; 0: off; 1: Discharge TES; 2: Discharge chiller)"
      annotation (Placement(transformation(extent={{260,-500},{280,-480}})));
    Modelica.Blocks.Interfaces.RealOutput Ptot_bldg2_sim
      "Second building's total power consumption" annotation (Placement(
          transformation(extent={{860,-710},{880,-690}}), iconTransformation(
            extent={{260,20},{280,40}})));
    Modelica.Blocks.Interfaces.RealOutput TtesRooAirSou_sim
      "Room air temperature" annotation (Placement(transformation(extent={{860,
              -502},{880,-482}}), iconTransformation(extent={{260,20},{280,40}})));
    Modelica.Blocks.Interfaces.RealOutput TtesRooAirEas_sim
      "Room air temperature" annotation (Placement(transformation(extent={{860,
              -542},{880,-522}}), iconTransformation(extent={{260,20},{280,40}})));
    Modelica.Blocks.Interfaces.RealOutput TtesRooAirNor_sim
      "Room air temperature" annotation (Placement(transformation(extent={{860,
              -582},{880,-562}}), iconTransformation(extent={{260,20},{280,40}})));
    Modelica.Blocks.Interfaces.RealOutput TtesRooAirWes_sim
      "Room air temperature" annotation (Placement(transformation(extent={{860,
              -622},{880,-602}}), iconTransformation(extent={{260,20},{280,40}})));
    Modelica.Blocks.Interfaces.RealOutput TtesRooAirCor_sim
      "Room air temperature" annotation (Placement(transformation(extent={{860,
              -462},{880,-442}}), iconTransformation(extent={{260,20},{280,40}})));
    Modelica.Blocks.Interfaces.RealOutput iceTanSOC_sim "state-of-charge"
      annotation (Placement(transformation(extent={{860,-670},{880,-650}}),
          iconTransformation(extent={{260,20},{280,40}})));
  equation
    ...
    connect(volToMode.y, uModtoInt.u)
      annotation (Line(points={{281,-490},{298,-490}}, color={0,0,127}));
    connect(Ptot_bldg2.y, Ptot_bldg2_sim) annotation (Line(points={{700.9,-684},
            {704,-684},{704,-700},{870,-700}}, color={0,0,127}));
    connect(TtesRooAirCor.y, TtesRooAirCor_sim) annotation (Line(points={{700.9,
            -436},{702,-436},{702,-452},{870,-452}}, color={0,0,127}));
    connect(TtesRooAirSou.y, TtesRooAirSou_sim) annotation (Line(points={{700.9,
            -476},{700.9,-492},{870,-492}}, color={0,0,127}));
    connect(TtesRooAirEas.y, TtesRooAirEas_sim) annotation (Line(points={{700.9,
            -516},{702,-516},{702,-532},{870,-532}}, color={0,0,127}));
    connect(TtesRooAirNor.y, TtesRooAirNor_sim) annotation (Line(points={{700.9,
            -556},{702,-556},{702,-572},{870,-572}}, color={0,0,127}));
    connect(TtesRooAirWes.y, TtesRooAirWes_sim) annotation (Line(points={{700.9,
            -596},{702,-596},{702,-612},{870,-612}}, color={0,0,127}));
    connect(iceTanSOC.y, iceTanSOC_sim) annotation (Line(points={{700.9,-644},{
            702,-644},{702,-660},{870,-660}}, color={0,0,127}));
    annotation (
      Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-400,-400},{1440,
              750}})),
      experiment(
      ...
      Icon(graphics={Text(
            ...
            textString="VAV Inputs"),
          Rectangle(extent={{-200,-60},{350,-380}}, lineColor={28,108,200})}));
  end TwoBldgs_1hil_1dSPACE_Python_20260126;

  model TwoBldgs_Ahil_BdSPACE_1vav_20260203
    "Building A (without TES) is in HIL setup with actual controllers; Building B (with TES) is in dSPACE with only 1 VAV controller using ASAM XIL API with Python for communication"
    extends dSpaceExample.FiveZones.BaseClasses.PartialHotWaterside(
      final Q_flow_boi_nominal=designHeatLoad,
      minFloBypHW(k=0.1),
      pumSpeHW(reset=Buildings.Types.Reset.Parameter, y_reset=0),
   ...
   extends dSpaceExample.FiveZones.BaseClasses.RunTime;
    ...
    Modelica.Blocks.Interfaces.RealInput yHeaCor
      "Voltage signal for heating coil" annotation (Placement(transformation(
            extent={{446,14},{474,42}}), iconTransformation(extent={{-120,-58},{
              -92,-30}})));
    UnitConversion.KToF kToF2
      annotation (Placement(transformation(extent={{1100,672},{1120,692}})));
    UnitConversion.ToAnolog toV2(
    ...
    Modelica.Blocks.Interfaces.RealInput yVAVCor
      "Voltage signal for VAV damper"
      annotation (Placement(transformation(extent={{446,46},{474,74}}),
          iconTransformation(extent={{446,46},{474,74}})));
    UnitConversion.FromAnalog volToUni_yhea2(
      v_min=0.1,
      v_max=10,
      y_min=0,
    ...
    Modelica.Blocks.Interfaces.RealOutput VCor_flow
      "Volume flow rate from port_a to port_b" annotation (Placement(
          transformation(extent={{560,358},{580,378}}), iconTransformation(extent=
             {{320,-58},{340,-38}})));
    Modelica.Blocks.Interfaces.RealOutput TDisSou
      "Temperature of the passing fluid" annotation (Placement(transformation(
            extent={{778,240},{798,260}}), iconTransformation(extent={{200,20},{
    ...
    Modelica.Blocks.Interfaces.RealOutput HCLT_V
      "heating coil leaving temperature" annotation (Placement(transformation(
            extent={{238,46},{258,66}}),iconTransformation(extent={{350,-140},{370,
              -120}})));
    Modelica.Blocks.Interfaces.RealOutput CCET_V
      "cooling coil entering temperature" annotation (Placement(transformation(
            extent={{228,74},{248,94}}), iconTransformation(extent={{350,-140},{370,
              -120}})));
    Modelica.Blocks.Interfaces.RealOutput HCLT "heating coil leaving temperature"
      annotation (Placement(transformation(extent={{200,76},{220,96}}),
          iconTransformation(extent={{350,-140},{370,-120}})));
    ...
    Modelica.Blocks.Interfaces.RealOutput cooMod_V annotation (Placement(
          transformation(extent={{912,-162},{932,-142}}), iconTransformation(
            extent={{350,-140},{370,-120}})));
    VirtualTestbed.NISTChillerTestbed.DemandFlexibilityInvestigation.FakeSystem.SystemForMPC_2iInput_modeSignal_Vcore
      bldg2TES
      annotation (Placement(transformation(extent={{402,-646},{582,-466}})));
    UnitConversion.KToF kToF22
      annotation (Placement(transformation(extent={{718,-486},{738,-466}})));
    UnitConversion.ToAnolog toV46(
      x_min=25,
    ...
    Modelica.Blocks.Sources.RealExpression TtesRooAirSou(y=bldg2TES.conVAVSou.TZon)
      annotation (Placement(transformation(extent={{640,-486},{698,-466}})));
    Modelica.Blocks.Math.RealToInteger uModtoInt
      "-1: Charge TES; 0: off; 1: Discharge TES; 2: Chiller only"
      annotation (Placement(transformation(extent={{320,-490},{340,-470}})));
    Modelica.Blocks.Interfaces.RealOutput TtesRooAirSou_V
      "Room air temperature" annotation (Placement(transformation(extent={{792,
              -486},{812,-466}}), iconTransformation(extent={{260,20},{280,40}})));
    Modelica.Blocks.Interfaces.RealInput yBldg2TES_uMod
      "Voltage signal (0-10 V) for mode control (-1: Charge TES; 0: off; 1: Discharge TES; 2: Discharge chiller)"
      annotation (Placement(transformation(extent={{226,-494},{254,-466}}),
          iconTransformation(extent={{-220,-260},{-200,-240}})));
    UnitConversion.KToF kToF23
      annotation (Placement(transformation(extent={{718,-526},{738,-506}})));
    UnitConversion.ToAnolog toV47(
    ...
    Modelica.Blocks.Interfaces.RealOutput iceTanSOC_sim "state-of-charge"
      annotation (Placement(transformation(extent={{860,-670},{880,-650}}),
          iconTransformation(extent={{260,20},{280,40}})));
    UnitConversion.FromAnalog volToUni_yvav6(
      v_min=0,
      v_max=10,
      y_min=0,
      y_max=1) annotation (Placement(transformation(extent={{280,-530},{300,
              -510}})));
    Modelica.Blocks.Interfaces.RealInput yBldg2TES_VAVCor_V
      "Voltage signal for VAV damper" annotation (Placement(transformation(
            extent={{226,-534},{254,-506}}), iconTransformation(extent={{446,46},
              {474,74}})));
    UnitConversion.ToAnolog toV53(
      x_min=0,
      x_max=10000,
      v_min=0,
      v_max=5)
      annotation (Placement(transformation(extent={{1034,-442},{1054,-422}})));
    UnitConversion.VToCFM vToCFM_vav6
      annotation (Placement(transformation(extent={{1004,-442},{1024,-422}})));
    Modelica.Blocks.Interfaces.RealOutput VtesCor_flow_V
      "Voltage measurement of Volume flow rate from port_a to port_b"
      annotation (Placement(transformation(extent={{1070,-442},{1090,-422}}),
          iconTransformation(extent={{320,-58},{340,-38}})));
    Modelica.Blocks.Interfaces.RealOutput VtesCor_flow_sim
      "Volume flow rate from port_a to port_b" annotation (Placement(
          transformation(extent={{1118,-460},{1138,-440}}), iconTransformation(
            extent={{320,-58},{340,-38}})));
    Modelica.Blocks.Sources.RealExpression VtesRooAirCor(y=bldg2TES.VSupCor_flow.V_flow)
      "Ai rvolume flow rate"
      annotation (Placement(transformation(extent={{920,-442},{978,-422}})));
    UnitConversion.KToF kToF27
      annotation (Placement(transformation(extent={{1244,-442},{1264,-422}})));
    UnitConversion.ToAnolog toV54(
      x_min=45,
      x_max=95,
      v_min=0,
      v_max=5)  "25/125F mapping to 0-10v"
      annotation (Placement(transformation(extent={{1276,-442},{1296,-422}})));
    Modelica.Blocks.Sources.RealExpression TtesDisAirCor(y=bldg2TES.TSupCor.T)
      annotation (Placement(transformation(extent={{1166,-442},{1224,-422}})));
    Modelica.Blocks.Interfaces.RealOutput TtesDisAirCor_V
      "Discharge air temperature" annotation (Placement(transformation(extent={
              {1318,-442},{1338,-422}}), iconTransformation(extent={{260,20},{
              280,40}})));
    Modelica.Blocks.Interfaces.RealOutput TtesDisAirCor_sim
      "Discharge air temperature" annotation (Placement(transformation(extent={
              {1386,-458},{1406,-438}}), iconTransformation(extent={{260,20},{
              280,40}})));
    Modelica.Blocks.Sources.RealExpression uModActual_bldg2(y=bldg2TES.uModActual.y)
      "Actual operational mode (-1: Charge TES; 0: off; 1: Discharge TES; 2: Chiller only)"
      annotation (Placement(transformation(extent={{640,-742},{698,-722}})));
    Modelica.Blocks.Interfaces.RealOutput uModActual_sim
      "Actual operational mode" annotation (Placement(transformation(extent={{
              860,-742},{880,-722}}), iconTransformation(extent={{260,20},{280,
              40}})));
  equation
    ...
    connect(wetBul.TWetBul, cooModCon.TWetBul) annotation (Line(points={{-279,
            ...
            {0,0,127}));
    connect(yHeaCor, volToUni_yhea1.v)
      annotation (Line(points={{460,28},{486.8,28}}, color={0,0,127}));
    connect(volToUni_yhea1.y, cor.yVal)
      annotation (Line(points={{500.6,28},{566,28},{566,34}}, color={0,0,127}));
    connect(kToF2.F,toV2. x)
      annotation (Line(points={{1121,682},{1124,682},{1124,684},{1126,684},{1126,
    ...
    connect(toV6.v, VCor_flow_V)
      annotation (Line(points={{551,342},{568,342}}, color={0,0,127}));
    connect(VSupCor_flow.V_flow, vToCFM_vav1.V_flow) annotation (Line(points={{569,130},
            {484,130},{484,342},{498,342}},          color={0,0,127}));
    connect(vToCFM_vav2.CFM, toV7.x)
      annotation (Line(points={{693,340},{700,340}}, color={0,0,127}));
    connect(toV7.v, VSou_flow_V)
      annotation (Line(points={{723,340},{744,340}}, color={0,0,127}));
    ...
    connect(TSupWes.T, kToF10.K) annotation (Line(points={{1289,90},{1210,90},{
            1210,280}}, color={0,0,127}));
    connect(yVAVCor, volToUni_yvav1.v) annotation (Line(points={{460,60},{486.8,
            60}},                      color={0,0,127}));
    connect(volToUni_yvav1.y, cor.yVAV)
      annotation (Line(points={{500.6,60},{566,60},{566,50}}, color={0,0,127}));
    connect(yHeaSou, volToUni_yhea2.v)
    ...
    connect(kToF6.F, TDisCor) annotation (Line(points={{521,280},{560,280},{560,
            254},{606,254}}, color={0,0,127}));
    connect(vToCFM_vav1.CFM, VCor_flow) annotation (Line(points={{521,342},{522,
            342},{522,368},{570,368}}, color={0,0,127}));
    connect(kToF7.F, TDisSou) annotation (Line(points={{691,280},{734.5,280},{
            734.5,250},{788,250}}, color={0,0,127}));
    connect(vToCFM_vav2.CFM, VSou_flow) annotation (Line(points={{693,340},{728.5,
            340},{728.5,402},{770,402}}, color={0,0,127}));
    ...
    connect(kToF17.F,toV27. x)
      annotation (Line(points={{197,56},{200,56}}, color={0,0,127}));
    connect(toV27.v,HCLT_V)
      annotation (Line(points={{223,56},{248,56}},   color={0,0,127}));
    connect(kToF17.F, HCLT) annotation (Line(points={{197,56},{197,72},{198,72},{
            198,86},{210,86}}, color={0,0,127}));
    connect(toV27.v, CCET_V) annotation (Line(points={{223,56},{223,72},{226,72},
            {226,84},{238,84}}, color={0,0,127}));
    connect(THeaCoo.T, kToF17.K)
      annotation (Line(points={{150,-29},{150,56},{174,56}}, color={0,0,127}));
    connect(kToF12.F,toV17. x)
      annotation (Line(points={{53,42},{58,42}}, color={0,0,127}));
    ...
    connect(TtesRooAirSou.y, kToF22.K)
      annotation (Line(points={{700.9,-476},{716,-476}},
                                                       color={0,0,127}));
    connect(uModtoInt.y, bldg2TES.uMod) annotation (Line(points={{341,-480},{
            372,-480},{372,-484},{384,-484}},       color={255,127,0}));
    connect(kToF23.F,toV47. x)
      annotation (Line(points={{739,-516},{748,-516}}, color={0,0,127}));
    connect(toV47.v, TtesRooAirEas_V)
      annotation (Line(points={{771,-516},{802,-516}}, color={0,0,127}));
    ...
    connect(iceTanSOC.y, iceTanSOC_sim) annotation (Line(points={{700.9,-644},{
            702,-644},{702,-660},{870,-660}}, color={0,0,127}));
    connect(yBldg2TES_VAVCor_V, volToUni_yvav6.v)
      annotation (Line(points={{240,-520},{278,-520}}, color={0,0,127}));
    connect(volToUni_yvav6.y, bldg2TES.yVAVCor)
      annotation (Line(points={{301,-520},{384,-520}}, color={0,0,127}));
    connect(vToCFM_vav6.CFM, toV53.x)
      annotation (Line(points={{1025,-432},{1032,-432}}, color={0,0,127}));
    connect(toV53.v, VtesCor_flow_V)
      annotation (Line(points={{1055,-432},{1080,-432}}, color={0,0,127}));
    connect(VtesRooAirCor.y, vToCFM_vav6.V_flow)
      annotation (Line(points={{980.9,-432},{1002,-432}}, color={0,0,127}));
    connect(VtesCor_flow_sim, VtesRooAirCor.y) annotation (Line(points={{1128,
            -450},{980.9,-450},{980.9,-432}}, color={0,0,127}));
    connect(kToF27.F,toV54. x)
      annotation (Line(points={{1265,-432},{1274,-432}},
                                                       color={0,0,127}));
    connect(toV54.v, TtesDisAirCor_V)
      annotation (Line(points={{1297,-432},{1328,-432}}, color={0,0,127}));
    connect(TtesDisAirCor.y, kToF27.K)
      annotation (Line(points={{1226.9,-432},{1242,-432}}, color={0,0,127}));
    connect(TtesDisAirCor.y, TtesDisAirCor_sim) annotation (Line(points={{
            1226.9,-432},{1228,-432},{1228,-448},{1396,-448}}, color={0,0,127}));
    connect(yBldg2TES_uMod, uModtoInt.u)
      annotation (Line(points={{240,-480},{318,-480}}, color={0,0,127}));
    connect(uModActual_bldg2.y, uModActual_sim)
      annotation (Line(points={{700.9,-732},{870,-732}}, color={0,0,127}));
    annotation (
      Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-400,-400},{1440,
              750}})),
      experiment(
      ...
      Icon(graphics={Text(
            ...
            textString="VAV Inputs"),
          Rectangle(extent={{-200,-60},{350,-380}}, lineColor={28,108,200})}));
  end TwoBldgs_Ahil_BdSPACE_1vav_20260203;
end MultiBuildings;
