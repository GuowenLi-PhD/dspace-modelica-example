...
model FiveZonesVAVAHU "System example for fault injection"
 ...
 extends dSpaceExample.FiveZones.BaseClasses.RunTime;
  ...
  Modelica.Blocks.Interfaces.RealOutput booChiPla "chiller plant status"
    annotation (Placement(transformation(extent={{1128,-206},{1148,-186}}),
        iconTransformation(extent={{350,-140},{370,-120}})));
  Modelica.Blocks.Interfaces.RealOutput Power_fan
                                                 annotation (Placement(
        transformation(extent={{288,-118},{308,-98}}),  iconTransformation(
          extent={{350,-140},{370,-120}})));
...
equation
  ...
  connect(chiWSE.mCHW_flow, mCHW_SI) annotation (Line(points={{673,-206},{670,-206},
          {670,-158},{700,-158},{700,-160}}, color={0,0,127}));
  ...
  connect(kToF17.F,toV27. x)
    annotation (Line(points={{197,56},{202,56}}, color={0,0,127}));
  connect(toV27.v,HCLT_V)
    annotation (Line(points={{225,56},{242,56}},   color={0,0,127}));
  connect(kToF17.F, HCLT) annotation (Line(points={{197,56},{197,72},{198,72},{
          198,86},{210,86}}, color={0,0,127}));
  connect(toV27.v, CCET_V) annotation (Line(points={{225,56},{225,72},{226,72},
  ...
  connect(fanSup.P, Power_fan) annotation (Line(points={{321,-31},{321,-92},{
          276,-92},{276,-108},{298,-108}}, color={0,0,127}));
