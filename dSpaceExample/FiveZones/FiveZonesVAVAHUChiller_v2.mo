...
model FiveZonesVAVAHUChiller_v2 "System example for fault injection"
  ...
  extends dSpaceExample.FiveZones.BaseClasses.PartialAirsideFiveZones(
    fanSup(show_T=false),
    conAHU(
      pNumIgnReq=1,
      TSupSetMin=284.95,
 ...
 extends dSpaceExample.FiveZones.BaseClasses.RunTime;
  ...
  Modelica.Blocks.Interfaces.RealOutput TSup_V "AHU supply air temperature"
                                                                  annotation (
      Placement(transformation(extent={{396,80},{416,100}}),
  ...
  Modelica.Blocks.Interfaces.RealOutput TMix_V
    "Mixed air temperautre leaviing economizer" annotation (Placement(
        transformation(extent={{112,60},{132,80}}), iconTransformation(extent={
            {350,-140},{370,-120}})));
  ...
  Modelica.Blocks.Interfaces.RealOutput dpDisSupFan_V
    "Supply fan static discharge pressure" annotation (Placement(transformation(
          extent={{244,80},{264,100}}), iconTransformation(extent={{350,-160},{
            370,-140}})));
  ...
  Modelica.Blocks.Interfaces.RealOutput TOut1 "Outdoor air temp"
                                                                annotation (
  ...
  Modelica.Blocks.Interfaces.RealOutput TDisCor
    "Temperature of the passing fluid" annotation (Placement(transformation(
          extent={{538,240},{558,260}}), iconTransformation(extent={{200,-60},{
            220,-40}})));
  ...
  Modelica.Blocks.Interfaces.RealOutput TDisSou
    "Temperature of the passing fluid" annotation (Placement(transformation(
          extent={{712,244},{732,264}}), iconTransformation(extent={{200,20},{
            220,40}})));
  Modelica.Blocks.Interfaces.RealOutput TDisEas
    "Temperature of the passing fluid" annotation (Placement(transformation(
          extent={{908,240},{928,260}}), iconTransformation(extent={{200,0},{
            220,20}})));
  ...
  Modelica.Blocks.Interfaces.RealOutput dpDisSupFan_ahu
    "Supply fan static discharge pressure" annotation (Placement(transformation(
          extent={{218,116},{238,136}}), iconTransformation(extent={{350,-160},
            {370,-140}})));
  Modelica.Blocks.Interfaces.RealOutput TSup_ahu "AHU supply air temperature"
    annotation (Placement(transformation(extent={{312,98},{332,118}}),
        iconTransformation(extent={{350,-100},{370,-80}})));
  ...
  UnitConversion.ToAnolog toV23(
    ...
    v_min=0,
    v_max=10)
    annotation (Placement(transformation(extent={{412,-176},{432,-156}})));
  UnitConversion.VToCFM vToCFM_ahu2
    annotation (Placement(transformation(extent={{382,-176},{402,-156}})));
  Modelica.Blocks.Interfaces.RealOutput VSup_ahu_V "Supply air flowrate"
    annotation (Placement(transformation(extent={{436,-176},{456,-156}}),
        iconTransformation(extent={{350,-120},{370,-100}})));
  Modelica.Blocks.Interfaces.RealOutput VSup_ahu "Supply air flowrate"
    annotation (Placement(transformation(extent={{408,-140},{428,-120}}),
        iconTransformation(extent={{350,-120},{370,-100}})));
  UnitConversion.KToF kToF14
    annotation (Placement(transformation(extent={{840,-134},{860,-114}})));
  UnitConversion.ToAnolog toV24(
    x_min=32,
    x_max=95,
    v_min=0,
    v_max=10)
    annotation (Placement(transformation(extent={{868,-134},{888,-114}})));
  Modelica.Blocks.Interfaces.RealOutput CCET_V
    "cooling coil entering temperature" annotation (Placement(transformation(
          extent={{922,-134},{942,-114}}), iconTransformation(extent={{350,-140},
            {370,-120}})));
  Modelica.Blocks.Interfaces.RealOutput CCET
    "cooling coil entering temperature" annotation (Placement(transformation(
          extent={{864,-106},{884,-86}}), iconTransformation(extent={{350,-140},
            {370,-120}})));
  UnitConversion.KToF kToF15
    annotation (Placement(transformation(extent={{628,-172},{648,-152}})));
  UnitConversion.ToAnolog toV25(
    x_min=32,
    x_max=95,
    v_min=0,
    v_max=10)
    annotation (Placement(transformation(extent={{656,-172},{676,-152}})));
  Modelica.Blocks.Interfaces.RealOutput CCLT_V
    "cooling coil leaving temperature" annotation (Placement(transformation(
          extent={{690,-170},{710,-150}}), iconTransformation(extent={{350,-140},
            {370,-120}})));
  Modelica.Blocks.Interfaces.RealOutput CCLT "cooling coil leaving temperature"
    annotation (Placement(transformation(extent={{652,-144},{672,-124}}),
        iconTransformation(extent={{350,-140},{370,-120}})));
  UnitConversion.KToF kToF16
    annotation (Placement(transformation(extent={{386,-238},{406,-218}})));
  UnitConversion.ToAnolog toV26(
    x_min=32,
    x_max=95,
    v_min=0,
    v_max=10)
    annotation (Placement(transformation(extent={{414,-238},{434,-218}})));
  Modelica.Blocks.Interfaces.RealOutput HCET_V
    "heating coil entering temperature" annotation (Placement(transformation(
          extent={{448,-238},{468,-218}}), iconTransformation(extent={{350,-140},
            {370,-120}})));
  Modelica.Blocks.Interfaces.RealOutput HCET
    "heating coil entering temperature" annotation (Placement(transformation(
          extent={{410,-210},{430,-190}}), iconTransformation(extent={{350,-140},
            {370,-120}})));
  UnitConversion.KToF kToF17
    annotation (Placement(transformation(extent={{386,-298},{406,-278}})));
  UnitConversion.ToAnolog toV27(
    x_min=32,
    x_max=95,
    v_min=0,
    v_max=10)
    annotation (Placement(transformation(extent={{414,-298},{434,-278}})));
  Modelica.Blocks.Interfaces.RealOutput HCLT_V
    "heating coil leaving temperature" annotation (Placement(transformation(
          extent={{448,-298},{468,-278}}), iconTransformation(extent={{350,-140},
            {370,-120}})));
  Modelica.Blocks.Interfaces.RealOutput HCLT "heating coil leaving temperature"
    annotation (Placement(transformation(extent={{410,-270},{430,-250}}),
        iconTransformation(extent={{350,-140},{370,-120}})));
  ...
  Modelica.Blocks.Interfaces.RealInput ySupFanOn
    "Voltage signal for ahu supply fan on/off" annotation (Placement(
        transformation(extent={{112,716},{130,734}}), iconTransformation(extent=
           {{-220,-100},{-200,-80}})));
  Modelica.Blocks.Math.RealToBoolean reaToBoo1(threshold=5)
    annotation (Placement(transformation(extent={{136,700},{146,710}})));
  Modelica.Blocks.Interfaces.RealInput yRetFanOn
    "Voltage signal for ahu return fan on/off" annotation (Placement(
        transformation(extent={{112,696},{130,714}}), iconTransformation(extent=
           {{-220,-100},{-200,-80}})));
  ...
  UnitConversion.FromAnalog volToUni_2(
    ...
    y_min=0,
    y_max=1)
    annotation (Placement(transformation(extent={{656,616},{674,634}})));
  Modelica.Blocks.Interfaces.RealInput yRetFanSpe
    "Voltage signal for ahu return fan speed" annotation (Placement(
        transformation(extent={{622,616},{640,634}}), iconTransformation(extent=
           {{-220,-160},{-200,-140}})));
  ...
  UnitConversion.KToF kToF18
    annotation (Placement(transformation(extent={{836,-180},{856,-160}})));
  UnitConversion.ToAnolog toV28(
    x_min=32,
    x_max=95,
    v_min=0,
    v_max=10)
    annotation (Placement(transformation(extent={{864,-180},{884,-160}})));
  Modelica.Blocks.Interfaces.RealOutput TCHW_Sup
    "chilled water supply temperature" annotation (Placement(transformation(
          extent={{860,-162},{880,-142}}), iconTransformation(extent={{350,-140},
            {370,-120}})));
  Modelica.Blocks.Interfaces.RealOutput TCHWSup_V
    "Chilled water supply temperature" annotation (Placement(transformation(
          extent={{912,-180},{932,-160}}),iconTransformation(extent={{350,-220},
            {370,-200}})));
  UnitConversion.KToF kToF19
    annotation (Placement(transformation(extent={{594,-258},{614,-238}})));
  UnitConversion.ToAnolog toV29(
    ...
    annotation (Placement(transformation(extent={{622,-258},{642,-238}})));
  Modelica.Blocks.Interfaces.RealOutput TCHWRet_V
    "Chilled water return temperature" annotation (Placement(transformation(
          extent={{654,-258},{674,-238}}), iconTransformation(extent={{350,-260},
            {370,-240}})));
  Modelica.Blocks.Interfaces.RealOutput TCHW_Ret
    "Chilled water return temperature" annotation (Placement(transformation(
          extent={{618,-282},{638,-262}}), iconTransformation(extent={{350,-260},
            {370,-240}})));
  UnitConversion.kgToLB kgToLB
    annotation (Placement(transformation(extent={{410,-364},{430,-344}})));
  UnitConversion.ToAnolog toV30(
    x_min=0,
    x_max=10,
    v_min=0,
    v_max=10)
    annotation (Placement(transformation(extent={{440,-364},{460,-344}})));
  Modelica.Blocks.Interfaces.RealOutput mCHW_V "CHW mass flow rate" annotation (
     Placement(transformation(extent={{468,-364},{488,-344}}),
        iconTransformation(extent={{350,-320},{370,-300}})));
  Modelica.Blocks.Interfaces.RealOutput mCHW "CHW mass flow rate" annotation (
      Placement(transformation(extent={{506,-360},{526,-340}}),
        iconTransformation(extent={{350,-320},{370,-300}})));
equation
  ...
  connect(toV16.v, TSup_V)
    annotation (Line(points={{393,90},{406,90}}, color={0,0,127}));
  ...
  connect(toV17.v, TMix_V)
    annotation (Line(points={{109,70},{122,70}}, color={0,0,127}));
  connect(TMix.T, kToF12.K) annotation (Line(points={{40,-29},{48,-29},{48,70},
          {58,70}}, color={0,0,127}));
  connect(vToCFM_ahu.CFM, toV18.x)
    annotation (Line(points={{-121,50},{-114,50}}, color={0,0,127}));
  connect(toV18.v, VOut_flow_V)
    annotation (Line(points={{-91,50},{-78,50}}, color={0,0,127}));
  ...
  connect(toV19.v, dpDisSupFan_V)
    annotation (Line(points={{241,90},{254,90}}, color={0,0,127}));
  connect(paTopsi_ahu.PSI, toV19.x)
    annotation (Line(points={{211,90},{218,90}}, color={0,0,127}));
  connect(dpDisSupFan.p_rel, paTopsi_ahu.Pa)
    annotation (Line(points={{311,0},{188,0},{188,90}}, color={0,0,127}));
  ...
  connect(reaTDryBul.y, kToF_TOut.K) annotation (Line(points={{-369,156},{-369,
          224},{-370,224},{-370,292}}, color={0,0,127}));
  connect(reaRH.y, gain.u) annotation (Line(points={{-369,136},{-369,197},{-370,
          197},{-370,258}}, color={0,0,127}));
  connect(kToF_TOut.F, TOut1) annotation (Line(points={{-347,292},{-344,292},{
          -344,352},{-332,352}}, color={0,0,127}));
  connect(gain.y, RHOut) annotation (Line(points={{-347,258},{-342,258},{-342,
          332},{-332,332}}, color={0,0,127}));
  connect(kToF6.F, TDisCor) annotation (Line(points={{521,280},{530,280},{530,
          250},{548,250}}, color={0,0,127}));
  connect(vToCFM_vav1.CFM, VCor_flow) annotation (Line(points={{521,342},{521,
          366},{544,366},{544,386}}, color={0,0,127}));
  connect(kToF7.F, TDisSou) annotation (Line(points={{691,280},{702,280},{702,
          254},{722,254}}, color={0,0,127}));
  connect(vToCFM_vav2.CFM, VSou_flow) annotation (Line(points={{693,340},{700,
          340},{700,392},{716,392}}, color={0,0,127}));
  connect(kToF8.F, TDisEas) annotation (Line(points={{907,280},{908,280},{908,
          250},{918,250}}, color={0,0,127}));
  connect(vToCFM_vav3.CFM, VEas_flow) annotation (Line(points={{905,340},{905,
          357},{932,357},{932,372}}, color={0,0,127}));
  connect(kToF9.F, TDisNor) annotation (Line(points={{1073,280},{1092,280},{
          1092,252},{1120,252}}, color={0,0,127}));
  connect(vToCFM_vav4.CFM, VNor_flow) annotation (Line(points={{1063,340},{
          1089.5,340},{1089.5,368},{1122,368}}, color={0,0,127}));
  connect(vToCFM_vav5.CFM, VWes_flow) annotation (Line(points={{1227,342},{1244,
          342},{1244,370},{1268,370}}, color={0,0,127}));
  connect(kToF10.F, TDisWes) annotation (Line(points={{1233,280},{1242,280},{
          1242,252},{1258,252}}, color={0,0,127}));
  connect(kToF1.F, TRooAirSou) annotation (Line(points={{1121,710},{1074,710},{
          1074,728},{1034,728}}, color={0,0,127}));
  connect(kToF2.F, TRooAirEas) annotation (Line(points={{1121,682},{1074,682},{
          1074,702},{1036,702}}, color={0,0,127}));
  connect(kToF3.F, TRooAirNor) annotation (Line(points={{1121,630},{1078,630},{
          1078,646},{1038,646}}, color={0,0,127}));
  ...
  connect(vToCFM_ahu.CFM, VOut_flow) annotation (Line(points={{-121,50},{-121,
          68},{-106,68},{-106,86}}, color={0,0,127}));
  connect(kToF12.F, TMix_ahu) annotation (Line(points={{81,70},{84,70},{84,98},
          {94,98}}, color={0,0,127}));
  connect(paTopsi_ahu.PSI, dpDisSupFan_ahu) annotation (Line(points={{211,90},{
          216,90},{216,126},{228,126}}, color={0,0,127}));
  connect(kToF11.F, TSup_ahu) annotation (Line(points={{365,90},{338,90},{338,
          108},{322,108}}, color={0,0,127}));
  connect(booToRea1.y, toV20.x)
    annotation (Line(points={{239,716},{250,716}}, color={0,0,127}));
  connect(toV20.v, BSupFanOn_V) annotation (Line(points={{273,716},{294,716},{
          294,720},{320,720}}, color={0,0,127}));
  connect(toV20.v, BRetFanOn_V) annotation (Line(points={{273,716},{294,716},{
          294,700},{324,700}}, color={0,0,127}));
  ...
  connect(vToCFM_ahu1.CFM, VRet_flow) annotation (Line(points={{357,248},{357,
          266},{372,266},{372,284}}, color={0,0,127}));
  ...
  connect(senRetFlo.V_flow, vToCFM_ahu1.V_flow) annotation (Line(points={{350,
          151},{342,151},{342,248},{334,248}}, color={0,0,127}));
  ...
  connect(kToF13.F, TRet_ahu) annotation (Line(points={{49,206},{52,206},{52,
          234},{62,234}}, color={0,0,127}));
  ...
  connect(vToCFM_ahu2.CFM, toV23.x)
    annotation (Line(points={{403,-166},{410,-166}}, color={0,0,127}));
  connect(toV23.v, VSup_ahu_V)
    annotation (Line(points={{433,-166},{446,-166}}, color={0,0,127}));
  connect(vToCFM_ahu2.CFM, VSup_ahu) annotation (Line(points={{403,-166},{403,
          -148},{418,-148},{418,-130}}, color={0,0,127}));
  connect(senSupFlo.V_flow, vToCFM_ahu2.V_flow) annotation (Line(points={{410,
          -29},{374,-29},{374,-166},{380,-166}}, color={0,0,127}));
  connect(kToF14.F,toV24. x)
    annotation (Line(points={{861,-124},{866,-124}},
                                               color={0,0,127}));
  connect(toV24.v, CCET_V)
    annotation (Line(points={{889,-124},{932,-124}}, color={0,0,127}));
  connect(kToF14.F, CCET) annotation (Line(points={{861,-124},{864,-124},{864,
          -96},{874,-96}}, color={0,0,127}));
  connect(TCHWSup.T, kToF14.K) annotation (Line(points={{768,-117},{804,-117},{
          804,-124},{838,-124}}, color={0,0,127}));
  connect(kToF15.F, CCLT) annotation (Line(points={{649,-162},{650,-162},{650,
          -134},{662,-134}}, color={0,0,127}));
  connect(toV25.v, CCLT_V) annotation (Line(points={{677,-162},{688,-162},{688,
          -160},{700,-160}}, color={0,0,127}));
  connect(TCHWRet.T, kToF15.K) annotation (Line(points={{608,-177},{618,-177},{
          618,-162},{626,-162}}, color={0,0,127}));
  connect(kToF16.F, HCET) annotation (Line(points={{407,-228},{408,-228},{408,
          -200},{420,-200}}, color={0,0,127}));
  connect(toV26.v, HCET_V) annotation (Line(points={{435,-228},{444,-228},{444,
          -228},{458,-228}}, color={0,0,127}));
  connect(THWSup.T, kToF16.K) annotation (Line(points={{339,-224},{340,-224},{
          340,-188},{374,-188},{374,-228},{384,-228}}, color={0,0,127}));
  connect(kToF17.F, HCLT) annotation (Line(points={{407,-288},{408,-288},{408,
          -260},{420,-260}}, color={0,0,127}));
  connect(toV27.v, HCLT_V)
    annotation (Line(points={{435,-288},{458,-288}}, color={0,0,127}));
  connect(THWRet.T, kToF17.K) annotation (Line(points={{87,-226},{87,-288},{384,
          -288}}, color={0,0,127}));
  connect(kToF15.F, toV25.x)
    annotation (Line(points={{649,-162},{654,-162}}, color={0,0,127}));
  connect(kToF16.F, toV26.x)
    annotation (Line(points={{407,-228},{412,-228}}, color={0,0,127}));
  connect(kToF17.F, toV27.x)
    annotation (Line(points={{407,-288},{412,-288}}, color={0,0,127}));
  connect(ySupFanOn, reaToBoo.u)
    annotation (Line(points={{121,725},{135,725}}, color={0,0,127}));
  connect(yRetFanOn, reaToBoo1.u)
    annotation (Line(points={{121,705},{135,705}}, color={0,0,127}));
  connect(reaToBoo.y, booToRea1.u) annotation (Line(points={{146.5,725},{181.25,
          725},{181.25,716},{216,716}}, color={255,0,255}));
  connect(boiPlaEnaDis.ySupFan, booToRea1.u) annotation (Line(points={{-280,
          -160},{-290,-160},{-290,26},{-298,26},{-298,70},{-254,70},{-254,690},
          {152,690},{152,725},{181.25,725},{181.25,716},{216,716}}, color={255,
          0,255}));
  connect(andFreSta.u2, booToRea1.u) annotation (Line(points={{-22,-138},{-156,
          -138},{-156,-112},{-290,-112},{-290,26},{-298,26},{-298,70},{-254,70},
          {-254,690},{152,690},{152,725},{181.25,725},{181.25,716},{216,716}},
        color={255,0,255}));
  connect(booToReaSupFan.u, booToRea1.u) annotation (Line(points={{1218,652},{
          688,652},{688,726},{158,726},{158,725},{181.25,725},{181.25,716},{216,
          716}}, color={255,0,255}));
  connect(chiPlaEnaDis.ySupFan, booToRea1.u) annotation (Line(points={{1098,
          -110},{1076,-110},{1076,652},{688,652},{688,726},{158,726},{158,725},
          {181.25,725},{181.25,716},{216,716}}, color={255,0,255}));
  connect(sigChaFan.u, booToRea1.u) annotation (Line(points={{1458,560},{1268,
          560},{1268,652},{688,652},{688,726},{158,726},{158,725},{181.25,725},
          {181.25,716},{216,716}}, color={255,0,255}));
  ...
  connect(fanSup.y, volToUni_6.y) annotation (Line(points={{310,-28},{358,-28},
          {358,76},{440,76},{440,454},{606,454},{606,625},{582.9,625}}, color={
          0,0,127}));
  connect(yHeaVal, volToUni_7.v)
    annotation (Line(points={{523,517},{546.2,517}}, color={0,0,127}));
  connect(volToUni_7.y, swiFreSta.u3) annotation (Line(points={{566.9,517},{
          566.9,442},{-88,442},{-88,-146},{18,-146},{18,-138}}, color={0,0,127}));
  connect(yCooVal, volToUni_1.v)
    annotation (Line(points={{627,517},{650.2,517}}, color={0,0,127}));
  connect(proCHWVal.u1, volToUni_1.y) annotation (Line(points={{466,-102},{462,
          -102},{462,426},{680,426},{680,517},{670.9,517}}, color={0,0,127}));
  connect(plaReqChi.uPlaVal, volToUni_1.y) annotation (Line(points={{1042,-110},
          {982,-110},{982,232},{786,232},{786,490},{680,490},{680,517},{670.9,
          517}}, color={0,0,127}));
  connect(yRetFanSpe, volToUni_2.v)
    annotation (Line(points={{631,625},{654.2,625}}, color={0,0,127}));
  ...
  connect(volToUni_4.y, eco.yRet) annotation (Line(points={{6.9,121},{24,121},{
          24,36},{-16.8,36},{-16.8,-34}}, color={0,0,127}));
  connect(volToUni_5.y, eco.yOut) annotation (Line(points={{6.9,95},{18,95},{18,
          40},{-10,40},{-10,-34}}, color={0,0,127}));
  connect(kToF18.F,toV28. x)
    annotation (Line(points={{857,-170},{862,-170}},
                                               color={0,0,127}));
  connect(kToF18.F, TCHW_Sup) annotation (Line(points={{857,-170},{860,-170},{
          860,-152},{870,-152}}, color={0,0,127}));
  connect(toV28.v, TCHWSup_V)
    annotation (Line(points={{885,-170},{922,-170}}, color={0,0,127}));
  connect(TCHWSup.T, kToF18.K) annotation (Line(points={{768,-117},{800,-117},{
          800,-170},{834,-170}}, color={0,0,127}));
  connect(kToF19.F,toV29. x)
    annotation (Line(points={{615,-248},{620,-248}}, color={0,0,127}));
  connect(toV29.v,TCHWRet_V)
    annotation (Line(points={{643,-248},{664,-248}}, color={0,0,127}));
  connect(TCHWRet.T, kToF19.K) annotation (Line(points={{608,-177},{588,-177},{
          588,-248},{592,-248}}, color={0,0,127}));
  connect(kgToLB.lb,toV30. x)
    annotation (Line(points={{431,-354},{438,-354}}, color={0,0,127}));
  connect(toV30.v,mCHW_V)
    annotation (Line(points={{461,-354},{478,-354}}, color={0,0,127}));
  connect(kgToLB.kg, chiWSE.mCHW_flow) annotation (Line(points={{408,-354},{408,
          -322},{490,-322},{490,-206},{673,-206}}, color={0,0,127}));
  connect(kgToLB.lb, mCHW) annotation (Line(points={{431,-354},{432,-354},{432,
          -330},{502,-330},{502,-350},{516,-350}}, color={0,0,127}));
  annotation (
