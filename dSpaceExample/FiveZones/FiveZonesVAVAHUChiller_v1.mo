...
model FiveZonesVAVAHUChiller_v1 "System example for fault injection"
 ...
 extends dSpaceExample.FiveZones.BaseClasses.RunTime;
  ...
  Modelica.Blocks.Interfaces.RealInput yHeaCor
    "Voltage signal for heating coil" annotation (Placement(transformation(
          extent={{454,14},{482,42}}), iconTransformation(extent={{-120,-60},{
            -92,-32}})));
  ...
  Modelica.Blocks.Interfaces.RealInput yHeaSou
    "Voltage signal for heating coil" annotation (Placement(transformation(
          extent={{626,14},{654,42}}), iconTransformation(extent={{-120,52},{
            -92,80}})));
  ...
  Modelica.Blocks.Interfaces.RealInput yHeaEas
    "Voltage signal for heating coil" annotation (Placement(transformation(
          extent={{810,14},{838,42}}), iconTransformation(extent={{-120,24},{
            -92,52}})));
  ...
  Modelica.Blocks.Interfaces.RealInput yHeaNor
    "Voltage signal for heating coil" annotation (Placement(transformation(
          extent={{970,14},{998,42}}), iconTransformation(extent={{-120,-4},{
            -92,24}})));
  ...
  Modelica.Blocks.Interfaces.RealInput yHeaWes
    "Voltage signal for heating coil" annotation (Placement(transformation(
          extent={{1150,14},{1178,42}}), iconTransformation(extent={{-120,-32},
            {-92,-4}})));
  ...
  Modelica.Blocks.Interfaces.RealOutput TSup_V "AHU supply air temperature"
      ...
      Placement(transformation(extent={{396,80},{416,100}}),
        iconTransformation(extent={{350,-80},{370,-60}})));
  ...
  Modelica.Blocks.Interfaces.RealOutput dpDisSupFan_V
    "Supply fan static discharge pressure" annotation (Placement(transformation(
          extent={{244,80},{264,100}}), iconTransformation(extent={{350,-140},{
            370,-120}})));
  UnitConversion.KToF kToF13
    annotation (Placement(transformation(extent={{848,-110},{868,-90}})));
  UnitConversion.ToAnolog toV20(
    ...
    v_max=10)
             "10c-40c mapping to 0-5v"
    annotation (Placement(transformation(extent={{876,-110},{896,-90}})));
  Modelica.Blocks.Interfaces.RealOutput TCHWSup_V
    "Chilled water supply temperature" annotation (Placement(transformation(
          extent={{900,-110},{920,-90}}), iconTransformation(extent={{350,-220},
            {370,-200}})));
  UnitConversion.KToF kToF14
    annotation (Placement(transformation(extent={{676,-170},{696,-150}})));
  UnitConversion.ToAnolog toV21(
    ...
    v_max=10)
             "10c-40c mapping to 0-5v"
    annotation (Placement(transformation(extent={{704,-170},{724,-150}})));
  Modelica.Blocks.Interfaces.RealOutput TCHWRet_V
    "Chilled water return temperature" annotation (Placement(transformation(
          extent={{728,-170},{748,-150}}), iconTransformation(extent={{350,-260},
            {370,-240}})));
  UnitConversion.KToF kToF15
    annotation (Placement(transformation(extent={{788,-276},{808,-256}})));
  UnitConversion.ToAnolog toV22(
    ...
    v_max=10)
             "10c-40c mapping to 0-5v"
    annotation (Placement(transformation(extent={{816,-276},{836,-256}})));
  Modelica.Blocks.Interfaces.RealOutput TCWSup_V
    "Condenser water supply temperature" annotation (Placement(transformation(
          extent={{840,-276},{860,-256}}), iconTransformation(extent={{350,-280},
            {370,-260}})));
  UnitConversion.KToF kToF16
    annotation (Placement(transformation(extent={{550,-280},{570,-260}})));
  UnitConversion.ToAnolog toV23(
    ...
    v_max=10)
             "10c-40c mapping to 0-5v"
    annotation (Placement(transformation(extent={{578,-280},{598,-260}})));
  Modelica.Blocks.Interfaces.RealOutput TCWRet_V
    "Condenser water return temperature" annotation (Placement(transformation(
          extent={{602,-280},{622,-260}}), iconTransformation(extent={{350,-240},
            {370,-220}})));
  UnitConversion.ToAnolog toV24(
    ...
    v_min=0,
    v_max=10)
    annotation (Placement(transformation(extent={{422,-148},{442,-128}})));
  UnitConversion.PaToPSI paTopsi_chw
    annotation (Placement(transformation(extent={{392,-148},{412,-128}})));
  Modelica.Blocks.Interfaces.RealOutput dpCHW_V "CHW differential pressure
" annotation (Placement(transformation(extent={{446,-148},{466,-128}}),
        iconTransformation(extent={{350,-300},{370,-280}})));
  ...
  UnitConversion.ToAnolog toV25(
    ...
    v_min=0,
    v_max=10)
    annotation (Placement(transformation(extent={{430,-200},{450,-180}})));
  Modelica.Blocks.Interfaces.RealOutput mCHW_V "CHW mass flow rate" annotation (
     Placement(transformation(extent={{458,-200},{478,-180}}),
  ...
  UnitConversion.ToAnolog toV26(
    ...
    v_max=10)
             "10c-40c mapping to 0-5v"
    annotation (Placement(transformation(extent={{428,-240},{448,-220}})));
  Modelica.Blocks.Interfaces.RealOutput TCHWSupWSE_V "CHW return temperature after WSE
" annotation (Placement(transformation(extent={{456,-240},{476,-220}}),
        iconTransformation(extent={{350,-380},{370,-360}})));
  UnitConversion.FromAnalog volToUni_yhea6(
    v_min=0,
    v_max=10,
    y_min=41,
    y_max=50)
    annotation (Placement(transformation(extent={{674,-250},{684,-240}})));
  Modelica.Blocks.Interfaces.RealInput yTCHWSet
    "Voltage signal for CHW supply temperature setpoint" annotation (Placement(
        transformation(extent={{650,-254},{668,-236}}), iconTransformation(
          extent={{-220,-220},{-200,-200}})));
  Modelica.Blocks.Math.RealToBoolean reaToBoo(threshold=5)
    annotation (Placement(transformation(extent={{740,-250},{750,-240}})));
  Modelica.Blocks.Interfaces.RealInput yCHOn
    "Voltage signal for chiller on/off" annotation (Placement(transformation(
          extent={{716,-254},{734,-236}}), iconTransformation(extent={{-220,
            -200},{-200,-180}})));
  UnitConversion.FromAnalog volToUni_yvav6(
    v_min=0,
    v_max=10,
    y_min=0,
    y_max=1) annotation (Placement(transformation(extent={{676,-276},{686,-266}})));
  Modelica.Blocks.Interfaces.RealInput yCHWPspe
    "Voltage signal for CHW pump speed" annotation (Placement(transformation(
          extent={{650,-280},{668,-262}}), iconTransformation(extent={{-220,
            -260},{-200,-240}})));
  UnitConversion.FromAnalog volToUni_yvav7(
    v_min=0,
    v_max=10,
    y_min=0,
    y_max=1) annotation (Placement(transformation(extent={{678,-294},{688,-284}})));
  Modelica.Blocks.Interfaces.RealInput yCHWval_min
    "Voltage signal for CHW min flow bypass valve" annotation (Placement(
        transformation(extent={{652,-298},{670,-280}}), iconTransformation(
          extent={{-220,-280},{-200,-260}})));
  UnitConversion.FromAnalog volToUni_yvav8(
    v_min=0,
    v_max=10,
    y_min=0,
    y_max=1) annotation (Placement(transformation(extent={{900,-218},{910,-208}})));
  Modelica.Blocks.Interfaces.RealInput yCWPspe
    "Voltage signal for CW pump speed" annotation (Placement(transformation(
          extent={{874,-222},{892,-204}}), iconTransformation(extent={{-220,
            -320},{-200,-300}})));
  UnitConversion.FromAnalog volToUni_yvav9(
    v_min=0,
    v_max=10,
    y_min=0,
    y_max=1) annotation (Placement(transformation(extent={{738,-292},{748,-282}})));
  Modelica.Blocks.Interfaces.RealInput yCTspe "Voltage signal for CT speed"
    annotation (Placement(transformation(extent={{712,-296},{730,-278}}),
        iconTransformation(extent={{-220,-360},{-200,-340}})));
  UnitConversion.ToAnolog toV_TOut(
    x_min=-20,
    x_max=120,
    v_min=0,
    v_max=10) "-20F-120F  mapping to 0 - 5V"
    annotation (Placement(transformation(extent={{-330,254},{-310,274}})));
  UnitConversion.KToF kToF_TOut
    annotation (Placement(transformation(extent={{-360,254},{-340,274}})));
  Modelica.Blocks.Interfaces.RealOutput TOut_V "Outdoor air temp" annotation (
      Placement(transformation(extent={{-300,254},{-280,274}}),
  ...
  UnitConversion.ToAnolog toV_RHOut(
    ...
    annotation (Placement(transformation(extent={{-330,220},{-310,240}})));
  ...
  Modelica.Blocks.Interfaces.RealOutput RHOut_V "Outdoor air rh" annotation (
      Placement(transformation(extent={{-300,220},{-280,240}}),
...
equation
  ...
  connect(cooModCon.y, cooTowSpeCon.cooMod) annotation (Line(points={{1049,
          -254.889},{1072,-254.889},{1072,-64},{1270,-64},{1270,-93.5556},{1284,
  ...
  connect(kToF13.F, toV20.x)
    annotation (Line(points={{869,-100},{874,-100}}, color={0,0,127}));
  connect(toV20.v, TCHWSup_V)
    annotation (Line(points={{897,-100},{910,-100}}, color={0,0,127}));
  connect(TCHWSup.T, kToF13.K) annotation (Line(points={{768,-117},{768,-100},{
          846,-100}}, color={0,0,127}));
  connect(kToF14.F, toV21.x)
    annotation (Line(points={{697,-160},{702,-160}}, color={0,0,127}));
  connect(toV21.v, TCHWRet_V)
    annotation (Line(points={{725,-160},{738,-160}}, color={0,0,127}));
  connect(TCHWRet.T, kToF14.K) annotation (Line(points={{608,-177},{608,-160},{
          674,-160}}, color={0,0,127}));
  connect(kToF15.F, toV22.x)
    annotation (Line(points={{809,-266},{814,-266}}, color={0,0,127}));
  connect(toV22.v, TCWSup_V)
    annotation (Line(points={{837,-266},{850,-266}}, color={0,0,127}));
  connect(TCWSup.T, kToF15.K) annotation (Line(points={{828,-305},{786,-305},{
          786,-266}}, color={0,0,127}));
  connect(kToF16.F, toV23.x) annotation (Line(points={{571,-270},{574,-270},{
          574,-270},{576,-270}}, color={0,0,127}));
  connect(toV23.v, TCWRet_V)
    annotation (Line(points={{599,-270},{612,-270}}, color={0,0,127}));
  connect(TCWRet.T, kToF16.K) annotation (Line(points={{544,-305},{544,-270},{
          548,-270}}, color={0,0,127}));
  connect(toV24.v, dpCHW_V)
    annotation (Line(points={{443,-138},{456,-138}}, color={0,0,127}));
  connect(paTopsi_chw.PSI, toV24.x)
    annotation (Line(points={{413,-138},{420,-138}}, color={0,0,127}));
  connect(senRelPre.p_rel, paTopsi_chw.Pa) annotation (Line(points={{568,-131},
          {478,-131},{478,-156},{390,-156},{390,-138}}, color={0,0,127}));
  connect(kgToLB.lb, toV25.x)
    annotation (Line(points={{421,-190},{428,-190}}, color={0,0,127}));
  connect(toV25.v, mCHW_V)
    annotation (Line(points={{451,-190},{468,-190}}, color={0,0,127}));
  connect(chiWSE.mCHW_flow, kgToLB.kg) annotation (Line(points={{673,-206},{396,
          -206},{396,-190},{398,-190}}, color={0,0,127}));
  connect(kToF17.F, toV26.x) annotation (Line(points={{421,-230},{422.5,-230},{
          422.5,-230},{426,-230}}, color={0,0,127}));
  connect(toV26.v, TCHWSupWSE_V)
    annotation (Line(points={{449,-230},{466,-230}}, color={0,0,127}));
  connect(chiWSE.TCHWSupWSE, kToF17.K) annotation (Line(points={{673,-212},{398,
          -212},{398,-230}}, color={0,0,127}));
  connect(yTCHWSet, volToUni_yhea6.v)
    annotation (Line(points={{659,-245},{673,-245}}, color={0,0,127}));
  connect(volToUni_yhea6.y, chiWSE.TSet) annotation (Line(points={{684.5,-245},
          {695.6,-245},{695.6,-218.8}}, color={0,0,127}));
  connect(yCHOn, reaToBoo.u)
    annotation (Line(points={{725,-245},{739,-245}}, color={0,0,127}));
  connect(reaToBoo.y, chiWSE.on[1]) annotation (Line(points={{750.5,-245},{
          755.25,-245},{755.25,-215.6},{695.6,-215.6}}, color={255,0,255}));
  connect(volToUni_yvav6.y, chiWSE.yPum[1]) annotation (Line(points={{686.5,
          -271},{702,-271},{702,-203.6},{695.6,-203.6}}, color={0,0,127}));
  connect(yCHWPspe, volToUni_yvav6.v) annotation (Line(points={{659,-271},{
          667.5,-271},{667.5,-271},{675,-271}}, color={0,0,127}));
  connect(yCHWval_min, volToUni_yvav7.v)
    annotation (Line(points={{661,-289},{677,-289}}, color={0,0,127}));
  connect(volToUni_yvav7.y, chiWSE.yVal7) annotation (Line(points={{688.5,-289},
          {704,-289},{704,-200.4},{695.6,-200.4}}, color={0,0,127}));
  connect(yCWPspe, volToUni_yvav8.v)
    annotation (Line(points={{883,-213},{899,-213}}, color={0,0,127}));
  connect(volToUni_yvav8.y, pumCW.y) annotation (Line(points={{910.5,-213},{924,
          -213},{924,-254},{886,-254},{886,-288},{898,-288}}, color={0,0,127}));
  connect(yCTspe, volToUni_yvav9.v) annotation (Line(points={{721,-287},{728.5,
          -287},{728.5,-287},{737,-287}}, color={0,0,127}));
  connect(volToUni_yvav9.y, cooTow.y) annotation (Line(points={{748.5,-287},{
          752,-287},{752,-302},{728,-302},{728,-308},{736,-308}}, color={0,0,
          127}));
  connect(kToF_TOut.F, toV_TOut.x)
    annotation (Line(points={{-339,264},{-332,264}}, color={0,0,127}));
  connect(toV_TOut.v, TOut_V)
    annotation (Line(points={{-309,264},{-290,264}}, color={0,0,127}));
  connect(reaTDryBul.y, kToF_TOut.K) annotation (Line(points={{-369,156},{-369,
          264},{-362,264}}, color={0,0,127}));
  connect(gain.y, toV_RHOut.x)
    annotation (Line(points={{-339,230},{-332,230}}, color={0,0,127}));
  connect(toV_RHOut.v, RHOut_V)
    annotation (Line(points={{-309,230},{-290,230}}, color={0,0,127}));
  connect(reaRH.y, gain.u) annotation (Line(points={{-369,136},{-366,136},{-366,
          230},{-362,230}}, color={0,0,127}));
  annotation (
    ...
    Icon(graphics={
        ...
        Text(
          extent={{308,-60},{348,-118}},
          lineColor={28,108,200},
          textString="AHU Outputs"),
        Text(
          extent={{300,-176},{346,-236}},
          lineColor={28,108,200},
          textString="Chiller Outputs"),
        Text(
          extent={{-200,-154},{-154,-214}},
          lineColor={28,108,200},
          textString="Chiller Inputs"),
        Text(
          extent={{106,22},{146,-36}},
          lineColor={28,108,200},
          textString="Outdoor air")}));
end FiveZonesVAVAHUChiller_v1;
