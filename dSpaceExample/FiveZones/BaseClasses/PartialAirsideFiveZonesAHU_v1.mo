...
partial model PartialAirsideFiveZonesAHU_v1
  "Variable air volume flow system with terminal reheat and five thermal zones"
  extends
    dSpaceExample.FiveZones.BaseClasses.PartialPhysicalAirsideFiveZonesAHU(      heaCoi(
        dp1_nominal=30000));
...
end PartialAirsideFiveZonesAHU_v1;
