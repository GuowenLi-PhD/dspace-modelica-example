...
partial model PartialAirsideFiveZonesWeather
  "Variable air volume flow system with terminal reheat and five thermal zones"
  extends
    dSpaceExample.FiveZones.BaseClasses.PartialPhysicalAirsideFiveZonesWeather(
                                                                              heaCoi(
        dp1_nominal=30000));
...
end PartialAirsideFiveZonesWeather;
