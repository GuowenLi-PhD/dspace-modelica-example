...
partial model PartialAirsideFiveZones
  "Variable air volume flow system with terminal reheat and five thermal zones"
  extends dSpaceExample.FiveZones.BaseClasses.PartialPhysicalAirsideFiveZones_v1(
                                                                              heaCoi(
        dp1_nominal=30000));
...
equation
  ...
  connect(conAHU.yOutDamPos, eco.yOut) annotation (Line(points={{424,522.667},{
          442,522.667},{442,198},{-10,198},{-10,-34}}, color={0,0,127}));
  connect(conAHU.yRetDamPos, eco.yRet) annotation (Line(points={{424,533.333},{
          450,533.333},{450,184},{-16,184},{-16,-34},{-16.8,-34}}, color={0,0,
          127}));
  connect(conAHU.yHea, swiFreSta.u3) annotation (Line(points={{424,554.667},{
          460,554.667},{460,156},{6,156},{6,-138},{18,-138}}, color={0,0,127}));
  annotation (
