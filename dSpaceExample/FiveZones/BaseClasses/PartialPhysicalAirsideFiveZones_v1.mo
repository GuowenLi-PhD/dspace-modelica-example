...
partial model PartialPhysicalAirsideFiveZones_v1 "Partial model of variable air volume flow system with terminal reheat and five 
...
end PartialPhysicalAirsideFiveZones_v1;
