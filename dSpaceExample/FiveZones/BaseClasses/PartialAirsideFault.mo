...
partial model PartialAirsideFault
  ...
  FaultInjection.Utilities.InsertionTypes.Variables.SignalBlock.Blocking fanSpeConAtt(faultMode=
    ...
    annotation (Placement(transformation(extent={{548,548},{568,568}})));
equation
  ...
  connect(fanSpeConAtt.u, conAHU.ySupFanSpe) annotation (Line(points={{546,558},
          {528,558},{528,618.667},{424,618.667}}, color={235,0,0}));
  connect(fanSpeConAtt.y, fanSup.y) annotation (Line(points={{569,558},{578,558},
          {578,424},{430,424},{430,-12},{308,-12},{308,-28},{310,-28}},
                                                              color={235,0,0}));
  annotation (
