...
partial model PartialPhysicalAirsideFiveZonesWeather "Partial model of variable air volume flow system with terminal reheat and five 
...
equation
  ...
  connect(weaBus, weaDat.weaBus) annotation (Line(
      points={{-320,180},{-330,180},{-330,210},{-340,210}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%first",
      index=-1,
...
end PartialPhysicalAirsideFiveZonesWeather;
