...
partial model PartialPhysicalAirsideFiveZonesAHU "Partial model of variable air volume flow system with terminal reheat and five 
...
equation
  ...
  connect(heaCoi.port_b2, THeaCoo.port_a)
    annotation (Line(points={{118,-40},{144,-40}}, color={0,127,255}));
  connect(THeaCoo.port_b, cooCoi.port_a2)
    annotation (Line(points={{164,-40},{190,-40}}, color={0,127,255}));
...
end PartialPhysicalAirsideFiveZonesAHU;
