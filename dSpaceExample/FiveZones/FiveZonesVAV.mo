...
model FiveZonesVAV "System example for fault injection"
 ...
 extends dSpaceExample.FiveZones.BaseClasses.RunTime;
  ...
  Modelica.Blocks.Interfaces.RealOutput TMix_ahu
    "Mixed air temperautre leaviing economizer" annotation (Placement(
        transformation(extent={{104,36},{124,56}}), iconTransformation(extent={{
            350,-140},{370,-120}})));
  UnitConversion.KToF kToF11
    annotation (Placement(transformation(extent={{314,64},{334,84}})));
  Modelica.Blocks.Interfaces.RealOutput TSup_ahu "AHU supply air temperature"
    annotation (Placement(transformation(extent={{342,64},{362,84}}),
        iconTransformation(extent={{350,-100},{370,-80}})));
  UnitConversion.VToCFM vToCFM_ahu2
    annotation (Placement(transformation(extent={{378,-120},{398,-100}})));
  Modelica.Blocks.Interfaces.RealOutput VSup_ahu "Supply air flowrate"
    annotation (Placement(transformation(extent={{406,-120},{426,-100}}),
        iconTransformation(extent={{350,-120},{370,-100}})));
  UnitConversion.VToCFM vToCFM_ahu
    annotation (Placement(transformation(extent={{-118,20},{-102,36}})));
  ...
  Modelica.Blocks.Interfaces.RealOutput booSupFan "supply fan status"
    annotation (Placement(transformation(extent={{490,682},{510,702}}),
        iconTransformation(extent={{350,-140},{370,-120}})));
  Modelica.Blocks.Interfaces.RealOutput yHeaCoi "heating coil signal"
    annotation (Placement(transformation(extent={{596,500},{616,520}}),
        iconTransformation(extent={{320,-58},{340,-38}})));
  Modelica.Blocks.Interfaces.RealOutput yCooCoi "cooling coil signal"
    annotation (Placement(transformation(extent={{596,476},{616,496}}),
        iconTransformation(extent={{320,-58},{340,-38}})));
  Modelica.Blocks.Interfaces.RealOutput ySupFanSpe "supply fan speed signal"
    annotation (Placement(transformation(extent={{544,632},{564,652}}),
        iconTransformation(extent={{350,-140},{370,-120}})));
  ...
  Modelica.Blocks.Interfaces.RealOutput mCHW_SI annotation (Placement(
        transformation(extent={{690,-170},{710,-150}}), iconTransformation(
          extent={{350,-140},{370,-120}})));
  UnitConversion.VToCFM vToCFM_ahu1
    annotation (Placement(transformation(extent={{326,242},{342,258}})));
  Modelica.Blocks.Interfaces.RealOutput VRet_flow "Outdoor air flowrate"
    annotation (Placement(transformation(extent={{362,240},{382,260}}),
        iconTransformation(extent={{350,-120},{370,-100}})));
equation
  ...
  connect(kToF13.F,TRet_ahu)  annotation (Line(points={{97,88},{114,88}},
                     color={0,0,127}));
  connect(kToF12.F, TMix_ahu)
    annotation (Line(points={{97,46},{114,46}}, color={0,0,127}));
  connect(kToF11.F,TSup_ahu)  annotation (Line(points={{335,74},{352,74}},
                      color={0,0,127}));
  connect(TSup.T, kToF11.K) annotation (Line(points={{340,-29},{340,46},{312,46},
          {312,74}}, color={0,0,127}));
  connect(TMix.T, kToF12.K) annotation (Line(points={{40,-29},{58,-29},{58,46},
          {74,46}}, color={0,0,127}));
  connect(TRet.T, kToF13.K) annotation (Line(points={{100,151},{78,151},{78,150},
          {74,150},{74,88}}, color={0,0,127}));
  connect(vToCFM_ahu2.CFM, VSup_ahu)
    annotation (Line(points={{399,-110},{416,-110}}, color={0,0,127}));
  connect(senSupFlo.V_flow, vToCFM_ahu2.V_flow) annotation (Line(points={{410,
          -29},{410,-10},{400,-10},{400,-92},{366,-92},{366,-110},{376,-110}},
        color={0,0,127}));
  connect(vToCFM_ahu.CFM,VOut_flow)  annotation (Line(points={{-101.2,28},{-86,
          28}},                           color={0,0,127}));
  connect(VOut1.V_flow, vToCFM_ahu.V_flow) annotation (Line(points={{-61,-20.9},
          {-119.6,-20.9},{-119.6,28}}, color={0,0,127}));
  connect(booToRea2.y, booSupFan)
    annotation (Line(points={{483,692},{500,692}}, color={0,0,127}));
  connect(conAHU.ySupFan, booToRea2.u) annotation (Line(points={{424,629.333},{
          436,629.333},{436,692},{460,692}}, color={255,0,255}));
  connect(conAHU.yHea, yHeaCoi) annotation (Line(points={{424,554.667},{590,
          554.667},{590,510},{606,510}}, color={0,0,127}));
  connect(conAHU.yCoo, yCooCoi) annotation (Line(points={{424,544},{512,544},{
          512,486},{606,486}}, color={0,0,127}));
  connect(conAHU.ySupFanSpe, ySupFanSpe) annotation (Line(points={{424,618.667},
          {484,618.667},{484,642},{554,642}}, color={0,0,127}));
  ...
  connect(THWRet.T, THWRet_K) annotation (Line(points={{87,-226},{80,-226},{80,
          -148},{136,-148},{136,-160}}, color={0,0,127}));
  connect(THWSup.T, THWSup_K) annotation (Line(points={{339,-224},{326,-224},{
          326,-166},{406,-166},{406,-170}}, color={0,0,127}));
  ...
  connect(chiWSE.mCHW_flow, mCHW_SI) annotation (Line(points={{673,-206},{670,
          -206},{670,-158},{700,-158},{700,-160}}, color={0,0,127}));
  connect(booToRea2.y, fanSup.y) annotation (Line(points={{483,692},{488,692},{
          488,598},{530,598},{530,382},{396,382},{396,-16},{310,-16},{310,-28}},
        color={0,0,127}));
  connect(chiPlaEnaDis.yPla, booToRea.u) annotation (Line(points={{1121,-110},{
          1144,-110},{1144,-116},{1166,-116}}, color={255,0,255}));
  connect(chiPlaEnaDis.yPla, minFloBypCHW.yPla) annotation (Line(points={{1121,
          -110},{1114,-110},{1114,-132},{1028,-132},{1028,-153},{1038,-153}},
        color={255,0,255}));
  connect(chiPlaEnaDis.yPla, cooModCon.yPla) annotation (Line(points={{1121,
          -110},{1108,-110},{1108,-226},{1026,-226},{1026,-247.333}}, color={
          255,0,255}));
  connect(vToCFM_ahu1.CFM, VRet_flow)
    annotation (Line(points={{342.8,250},{372,250}}, color={0,0,127}));
  connect(senRetFlo.V_flow, vToCFM_ahu1.V_flow) annotation (Line(points={{350,
          151},{324.4,151},{324.4,250}}, color={0,0,127}));
  annotation (
