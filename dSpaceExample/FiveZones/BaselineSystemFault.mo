...
model BaselineSystemFault "System example for fault injection"
  ...
  extends dSpaceExample.FiveZones.BaseClasses.PartialAirsideFault(
    fanSup(show_T=false),
    conAHU(
      pNumIgnReq=1,
      TSupSetMin=284.95,
...
equation
  ...
  connect(occSch.occupied, booToRea1.u) annotation (Line(points={{-297,-76},{-294,
          -76},{-294,-14},{-308,-14},{-308,2}}, color={255,0,255}));
  annotation (
